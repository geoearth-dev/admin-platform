...
public class JobInvokeUtil {
    ...
    private static void invokeMethod(Object bean, String methodName, List<Object[]> methodParams)
        ...
        if (ObjUtil.isNotNull(methodParams) && !methodParams.isEmpty()) {
    ...
    public static List<Object[]> getMethodParams(String invokeTarget) {
        if (invokeTarget.indexOf('(') < 0) {
            return null;
        }
        String methodStr = invokeTarget.substring(invokeTarget.indexOf('(') + 1, invokeTarget.lastIndexOf(')')).trim();
