...
public class FileUtils {
    ...
    public static String writeBytes(byte[] data, String uploadDir) throws IOException {
        ...
        try {
            ...
            pathName = DateTimeFormat.DATE_PATH.format(Instant.now()) + "/" + IdUtil.fastUUID() + "." + extension;
     ...
     * @return true 正常 false 非法
     */
    public static boolean isDownloadAllowed(String resource) {
        // 禁止目录上跳级别
    ...
    /**
     * 获取文件名称 /profile/upload/2026/08/31/avatar.png -- avatar.png
     *
     * @param fileName 路径名称
     * @return 没有文件路径的名称
     */
    ...
    /**
     * 获取不带后缀文件名称 /profile/upload/2026/08/31/avatar.png -- avatar
     *
     * @param fileName 路径名称
     * @return 没有文件路径和后缀的名称
     */
