...
public interface SysDeptMapper extends BaseMapperX<SysDept>
{
     ...
     * 
     * @param roleId 角色ID
     * @param deptCheckLinked 部门树勾选是否父子联动（true：联动，false：独立勾选）
     * @return 选中部门列表
     */
    List<Long> selectDeptListByRoleId(@Param("roleId") Long roleId, @Param("deptCheckLinked") boolean deptCheckLinked);
     ...
     * @param dept 部门信息
     */
    default void updateDeptSort(SysDept dept) {
        updateById(dept);
    }
