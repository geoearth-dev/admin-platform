...
import { IFrameView } from '@/layout';

// 本地详情页统一注册在 Index 布局下，通过权限码控制访问。
const exampleDynamicRouter: RouteRecordRaw[] = [
  {
    meta: {
        ...
        children: [
          {
            ...
            path: '403',
            component: () => import('@/views/sys/admin/fallback/forbidden.vue'),
            meta: {
          ...
          },
          {
            ...
            path: '500',
            component: () => import('@/views/sys/admin/fallback/internal-error.vue'),
            meta: {
          ...
          },
          {
            ...
            path: 'offline',
            component: () => import('@/views/sys/admin/fallback/offline.vue'),
            meta: {
              icon: 'mdi:offline',
