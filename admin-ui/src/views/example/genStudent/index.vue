  ...
  <div class="app-container" ref="app-container">
    ...
    <div class="pagecont-bottom">
      ...
      >
        ...
        <el-table-column v-if="getColumnVisibility(5)" label="年龄" align="center" prop="age">
          <template #default="scope">
            {{ scope.row.age || '-' }}
          </template>
        </el-table-column>
        ...
        <el-table-column v-if="getColumnVisibility(7)" label="班级" align="center" prop="grade">
          <template #default="scope">
            {{ scope.row.grade || '-' }}
          </template>
        </el-table-column>
        <el-table-column v-if="getColumnVisibility(8)" label="爱好" align="center" prop="hobby">
          <template #default="scope">
            <dict-tag
          ...
          <el-col :span="12">
            <el-form-item label="爱好" prop="hobby">
              <el-checkbox-group v-model="form.hobby">
                <el-checkbox v-for="dict in message_level" :key="dict.value" :label="dict.value">
                  {{ dict.label }}
                </el-checkbox>
              </el-checkbox-group>
            </el-form-item>
...
function importTemplate() {
  proxy.download('system/user/importTemplate', {}, `student_template_${new Date().getTime()}.xlsx`);
}
