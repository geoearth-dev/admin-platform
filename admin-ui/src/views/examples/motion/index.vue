...
import { Motion, MotionGroup, MotionPresets } from '@/components/motion'
...
const presets = MotionPresets.filter((v: string) => !v.includes('Visible'))
        ...
        >
          <ElRow>
            <ElCol :span="8">
              ...
              >
                <ElSelectV2
                  v-model="motionProps.preset"
                  :options="
                    presets.map((p: string) => ({ label: p, value: p }))
                  "
                />
              </ElFormItem>
            </ElCol>
        ...
        >
          <ElRow>
            <ElCol :span="8">
              ...
              >
                <ElSelectV2
                  v-model="motionGroupProps.preset"
                  :options="
                    presets.map((p: string) => ({ label: p, value: p }))
                  "
                />
