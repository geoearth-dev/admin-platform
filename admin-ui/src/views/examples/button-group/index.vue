...
import { LoaderCircle, Square, SquareCheckBig } from '@/assets/icons'
...
function beforeChange(v: unknown, isChecked: boolean) {
...
function onBtnClick(value: unknown) {
