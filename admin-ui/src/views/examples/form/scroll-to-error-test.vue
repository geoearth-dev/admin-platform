...
// 切换滚动功能
function toggleScrollToError(checked: string | number | boolean) {
  formApi.setState({ scrollToFirstError: checked === true })
}
      ...
      <div class="space-y-4">
        ...
        <div class="rounded-sm border p-4">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <ElButton @click="testValidateField">
              测试 validateField()
            </ElButton>
          </div>
        ...
        <div class="rounded-sm border p-4">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <ElButton @click="() => formApi.reset()"> 清空表单 </ElButton>
          </div>
          <div class="mt-2 text-xs text-gray-500">
