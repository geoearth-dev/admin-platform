...
import useDictStore from '@/store/system/admin/dict.js';
import { optionselect as getDictOptionselect, getType } from '@/api/system/admin/dict/type';
import { listData, getData, delData, addData, updateData } from '@/api/system/admin/dict/data';
