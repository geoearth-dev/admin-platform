...
import { getLayoutScrollElement, getScrollbarWidth, needsScrollbar } from '../../utils/dom';
...
export function useScrollLock(options: ScrollLockOptions = {}) {
  ...
  function applyScrollbarGutter(target: HTMLElement) {
    ...
    target.dataset.scrollbarGutter = target.style.getPropertyValue('scrollbar-gutter');
