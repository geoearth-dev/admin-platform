...
import type { HoverCardContentProps } from '@/plugins/vben-ui/shadcn-ui';

import type { MenuItemRegistered, MenuProvider, SubMenuProps } from '../types';

import { computed, onBeforeUnmount, onMounted, reactive, ref } from 'vue';

import { useNamespace } from '@/plugins/composables';
import { VbenHoverCard } from '@/plugins/vben-ui/shadcn-ui';
...
const isTopLevelMenuSubmenu = computed(() => parentMenu.value?.type.name === 'MenuUI');
