...
import type { TabConfig, TabsEmits, TabsProps } from '../../types';

import { computed } from 'vue';

import { Pin, X } from '@/assets/icons';
import { VbenContextMenu, VbenIcon } from '@/plugins/vben-ui/shadcn-ui';
defineOptions({
  name: 'VbenTabsChrome',
  inheritAttrs: false,
});
...
<style scoped>
@reference "@/assets/css/tailwind/theme.css";
