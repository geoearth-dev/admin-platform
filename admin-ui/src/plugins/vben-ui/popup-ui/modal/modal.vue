...
import { Expand, Shrink } from '@/assets/icons';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { ELEMENT_ID_MAIN_CONTENT } from '@/constants/globals';
import { globalShareState } from '@/plugins/global-state';
import { cn } from '@/utils/cn';

import { useModalDraggable } from './use-modal-draggable';
import { useSimpleLocale } from '@/plugins/locale/use-simple-locale';
import { usePriorityValues } from '@/plugins/composables';
