...
} from '@/plugins/composables';
import { ELEMENT_ID_MAIN_CONTENT, ELEMENT_ID_LAYOUT_SCROLL } from '@/constants/globals';

defineOptions({
  name: 'VbenLayout',
});

const props = withDefaults(defineProps<VbenLayoutProps>(), {
  contentCompact: 'wide',
