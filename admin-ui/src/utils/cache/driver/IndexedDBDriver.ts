import type { IStorageDriver } from "../type";
...
class IndexedDBDriver implements IStorageDriver {
  ...
  constructor({ dbName = 'admin-storage', dbVersion = 1, storeName = 'kv-store' }: IndexedDBDriverOptions = {}) {
    this.dbName = dbName;
...
export { IndexedDBDriver, type IndexedDBDriverOptions };
