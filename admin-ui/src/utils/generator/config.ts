import type { FormConfig, PaletteItem } from './types'
...
export const inputComponents: PaletteItem[] = [
  {
    label: '单行文本',
    tag: 'el-input',
    tagIcon: 'input',
...
export const selectComponents: PaletteItem[] = [
  {
    label: '下拉选择',
    tag: 'el-select',
    tagIcon: 'select',
...
export const layoutComponents: PaletteItem[] = [
  {
    layout: 'rowFormItem',
    tagIcon: 'row',
    type: 'default',
