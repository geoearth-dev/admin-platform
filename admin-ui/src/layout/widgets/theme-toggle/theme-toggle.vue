...
import { preferences, updatePreferences, usePreferences } from '@/plugins/preference/index.ts';

import { ToggleGroup, ToggleGroupItem, VbenTooltip } from '@/plugins/vben-ui/shadcn-ui/index.ts';
