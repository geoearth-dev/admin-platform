    ...
    <div v-if="!authPanelCenter" class="relative hidden w-0 flex-1 lg:block">
      <div class="absolute inset-0 size-full bg-background-deep dark:bg-[#070709]">
        ...
        <div
          ...
          :class="{ 'enter-x': authPanelLeft, '-enter-x': authPanelRight }"
        >
...
import { Copyright } from '../basic/copyright/index.ts';
import AuthenticationFormView from './form.vue';
import SloganIcon from './icons/slogan.vue';
import Toolbar from './toolbar.vue';
import type { ToolbarType } from './types.ts';
import { preferences, usePreferences } from '@/plugins/preference/index.ts';
interface Props {
  appName?: string;
  logo?: string;
  logoDark?: string;
