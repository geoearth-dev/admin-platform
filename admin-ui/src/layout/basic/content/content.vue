...
import { getTabKey, useTabbarStore } from '@/store';
import { storeToRefs } from 'pinia';
import { transformComponent, useLayoutHook } from '@/layout/hooks';
...
<template>
  <div class="relative h-full">
    ...
    <RouterView v-slot="{ Component, route }">
      ...
      <Transition v-if="getEnabledTransition" :name="getTransitionName(route)" appear>
