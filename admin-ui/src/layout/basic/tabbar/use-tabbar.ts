...
import { useContentMaximize, useTabs } from '@/plugins/effects/hooks';
import { $t } from '@/plugins/locale';
import type { IContextMenuItem } from '@/plugins/vben-ui/tabs-ui';
import { useAccessStore, useTabbarStore, getTabKey } from '@/store';
import type { TabDefinition } from '@/types/base/tabs';
